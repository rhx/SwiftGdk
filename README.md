...
The Swift wrappers have been tested with glib-2.56, 2.58, 2.60, 2.62, 2.64, and gdk/gtk 3.22, 3.24, and 4.0.  They should work with higher versions, but YMMV.  Also make sure you have `gobject-introspection` and its `.gir` files installed.
